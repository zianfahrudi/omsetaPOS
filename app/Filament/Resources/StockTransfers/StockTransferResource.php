...
class StockTransferResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Pemindahan Barang';

    protected static ?string $modelLabel = 'Pemindahan Barang';

    protected static ?string $pluralModelLabel = 'Pemindahan Barang';
