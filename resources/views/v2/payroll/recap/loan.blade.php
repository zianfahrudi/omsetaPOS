...
@section('title', 'Rekap Bon')
@section('heading', 'Rekap Bon / Kasbon Karyawan')

@php
    $rp = fn ($v) => 'Rp '.number_format((float) $v, 0, ',', '.');
    $statusBadge = ['pending' => 'bg-amber-50 text-amber-700', 'deducted' => 'bg-slate-100 text-slate-600', 'paid' => 'bg-emerald-50 text-emerald-700'];
...
@section('content')
    <div class="flex flex-wrap items-end justify-between gap-3">
        ...
        <a href="{{ route('v2.payrolls.recap.loan.print', ['month' => $month, 'employee_id' => $employeeId]) }}" target="_blank"
