...
@section('content')
    ...
    <div class="mb-4 flex flex-wrap gap-2">
        @if ((float) $invoice->outstanding_amount > 0)
            <a href="{{ route('v2.sales.invoices.payment', $invoice) }}" class="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700">Catat Pembayaran</a>
        @endif
        <a href="{{ route('v2.sales.invoices.return', $invoice) }}" class="rounded-lg border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">Retur Penjualan</a>
        <a href="{{ route('v2.sales.invoices.print', $invoice) }}" target="_blank" class="rounded-lg border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">Cetak Faktur</a>
    </div>
