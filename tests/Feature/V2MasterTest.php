...
class V2MasterTest extends TestCase
{
    ...
    public function test_unit_crud_flow(): void
    {
        ...
        $unit = \App\Models\Unit::query()->where('name', 'Karton')->firstOrFail();
        ...
        $this->assertNull(\App\Models\Unit::query()->find($unit->id));
    }
    ...
    public function test_tax_store_persists(): void
    {
        ...
        $this->assertTrue(\App\Models\Tax::query()->where('name', 'PPN 12%')->exists());
    }
}
